        ...
        <>
          ...
          <section className="main">
            ...
            <section className="faq_header">
              ...
              <article className="faq_header-img-box">
                <img
            ...
            <section className="faq-list">
              ...
              <FAQListItem title="What is the security deposit for?">
                <article>
                  <p className="faq_list-item_content-text">
                    RND requires a security deposit (minimum $250) before you
                    can drive any car. If your payment type is a debit card,
                    this amount will be deducted from your account; if it is a
                    credit card, the amount will be pre-authorized. In either
                    case, you will be charged when you initially rent the car.
                    However, if the trip is scheduled to begin more than a week
                    from the time you’ve paid for the rental, the security
                    deposit will be charged one week prior to day one of the
                    trip. If the security deposit is declined, your trip will be
                    automatically canceled.
                  </p>
                  <p className="faq_list-item_content-text">
                    This deposit will be refunded 72 hours after you return the
                    car in the condition in which you received it. Depending on
                    your bank or payment method, it may take up to seven
                    business days after we release the deposit for the funds to
                    be available in your account. Credit cards will usually be
                    refunded more quickly, as there will be a release of
                    authorization.
                  </p>
                </article>
              </FAQListItem>
              ...
              <FAQListItem title="Is roadside assistance included?">
                <section>
                  <p className="faq_list-item_content-text">
                    ...
                    rentals include comprehensive roadside service during the
                    rental period. This roadside assistance is included with
                    every rental at no cost to the owner or renter. This service
                    is provided through Hagerty Drivers Club® and includes:
                  </p>
                  <ul className="faq_list-item_content-text_list">
                    <li>Guaranteed flatbed towing with soft straps</li>
                    <li>
                      Dispatch operators who understand and care about special
                      cars
                    </li>
                    ...
                    <li>
                      Live truck tracking, text status updates, Lyft credit and
                      more
                    </li>
                    <li>
                      Depending on the circumstances, a refund of the rental
                      costs may be offered to the renter
                    </li>
                  </ul>
                  <p className="faq_list-item_content-text">
                    If you are having a problem with an RND car you rented and
                    need roadside assistance, please call 1-877-922-1702 (prompt
                    #3).
                  </p>
                  <p className="faq_list-item_content-text">
                    Depending on the circumstances of the issue, a full or
                    partial refund of the rental fee may be offered to the
                    renter. Please contact us at support@rndkc.com.
                  </p>
                </section>
              </FAQListItem>
              <FAQListItem
              ...
              <FAQListItem title="What are prohibited vehicle uses?">
                <p className="faq_list-item_content-text">
                  At this time, we are unable to include vehicles described as
                  being used for any off-road, racing, timed events or driver's
                  education on the DriveShare.com platform due to insurance
                  restrictions.
                </p>
                <p className="faq_list-item_content-text">
                ...
                <ul className="faq_list-item_content-text_list">
                  <li>
                    Permitting someone who is not an approved RND driver to
                    drive an RND vehicle.
                  </li>
                  <li>
                    Driving a manual transmission car without being expert in
                    the use of clutches and manual transmissions. Note: If the
                    drivetrain of a manual transmission car is damaged, the
                    renter will be presumed to be at fault and will be held
                    fully liable for repair of any damaged components of the
                    car.
                  </li>
                  <li>
                    Allowing the RND vehicle to be pushed or towed by anyone
                    other than an authorized law enforcement or a RND-approved
                    service vehicle.
                  </li>
                </ul>
                <p className="faq_list-item_content-text">
                  Using an RND vehicle:
                </p>
                <ul className="faq_list-item_content-text_list">
                  ...
                  <li>
                    with the intention to cause damage, or with deliberate,
                    willful or reckless disregard for safety
                  </li>
                  <li>
                    to carry persons or property for hire, such as a taxi or
                    parcel delivery service. You may, however, use the car for
                    business purposes, such as attending meetings and carrying
                    associated materials
                  </li>
                  <li>
                    unless a reservation has been booked. Using DriveShare
                    vehicles without reservations or outside your reservation
                    time constitutes unauthorized use
                  </li>
                  <li>
                    during or due to use in the commission of a crime or any
                    other illegal activity or purpose
                  </li>
                ...
                <p className="faq_list-item_content-text">
                  ...
                  grounds for fees, suspension or cancellation of your
                  membership. It will also lower the renter's liability coverage
                  to state minimum limits or nullify coverage where allowable by
                  applicable state law; if the owner has encouraged the
                  engagement in a Prohibited Use, their coverage may be
                  similarly reduced. Engaging in any Prohibited Uses may also
                  eliminate any coverage for the renter for any claims related
                  to physical damage.
                </p>
              </FAQListItem>
            </section>
