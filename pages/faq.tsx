      ...
      <>
        ...
        <FAQListItem title="What is the security deposit for?">
          <article>
            <p className="faq_list-item_content-text">
              ...
              amount will be pre-authorized. In either case, you will be charged
              when you initially rent the car. However, if the trip is scheduled
              to begin more than a week from the time you’ve paid for the
              rental, the security deposit will be charged one week prior to day
              one of the trip. If the security deposit is declined, your trip
              will be automatically canceled.
            </p>
            <p className="faq_list-item_content-text">
              This deposit will be refunded 72 hours after you return the car in
              the condition in which you received it. Depending on your bank or
              payment method, it may take up to seven business days after we
              release the deposit for the funds to be available in your account.
              Credit cards will usually be refunded more quickly, as there will
              be a release of authorization.
            </p>
          </article>
        </FAQListItem>
        <FAQListItem
        ...
        <FAQListItem title="Is roadside assistance included?">
          <section>
            <p className="faq_list-item_content-text">
              ...
              period. This roadside assistance is included with every rental at
              no cost to the owner or renter. This service is provided through
              Hagerty Drivers Club® and includes:
            </p>
            <ul className="faq_list-item_content-text_list">
              ...
              <li>
                Dispatch for lockouts, battery jumps, tire changes and emergency
                fuel delivery
              </li>
              <li>
              ...
              <li>
                Depending on the circumstances, a refund of the rental costs may
                be offered to the renter
              </li>
            </ul>
            <p className="faq_list-item_content-text">
        ...
        <FAQListItem title="What are prohibited vehicle uses?">
          <p className="faq_list-item_content-text">
            ...
            used for any off-road, racing, timed events or driver's education on
            the DriveShare.com platform due to insurance restrictions.
          </p>
          <p className="faq_list-item_content-text">
          ...
          <ul className="faq_list-item_content-text_list">
            ...
            <li>
              Driving a manual transmission car without being expert in the use
              of clutches and manual transmissions. Note: If the drivetrain of a
              manual transmission car is damaged, the renter will be presumed to
              be at fault and will be held fully liable for repair of any
              damaged components of the car.
            </li>
            <li>
          ...
          <ul className="faq_list-item_content-text_list">
            ...
            <li>
              with the intention to cause damage, or with deliberate, willful or
            ...
            <li>
              ...
              without reservations or outside your reservation time constitutes
              unauthorized use
            </li>
            <li>
            ...
            <ul className="faq_list-item_content-text_list">
              ...
              <li>
                any drug or medication under the effects of which the operation
                of a vehicle is prohibited or not recommended
              </li>
            </ul>
          </ul>
          <p className="faq_list-item_content-text">
            Engaging in any Prohibited Uses with an RND vehicle will be grounds
            for fees, suspension or cancellation of your membership. It will
            also lower the renter's liability coverage to state minimum limits
            or nullify coverage where allowable by applicable state law; if the
            owner has encouraged the engagement in a Prohibited Use, their
            coverage may be similarly reduced. Engaging in any Prohibited Uses
            may also eliminate any coverage for the renter for any claims
